      ...
      <div className="mx-auto max-w-[1360px]">
        ...
        >
          ...
          <a
            ...
            className="mx-auto inline-flex min-w-0 max-w-full items-center gap-2.5 rounded-full border border-white/70 bg-white/45 px-5 py-[0.6rem] text-center text-sm font-medium text-[#0D1522] shadow-[0_2px_12px_rgba(13,21,34,0.05),inset_0_1px_0_rgba(255,255,255,0.7)] backdrop-blur-xl backdrop-saturate-150 transition hover:bg-white/65 hover:shadow-[0_6px_20px_rgba(13,21,34,0.09),inset_0_1px_0_rgba(255,255,255,0.8)] sm:mx-0 sm:shrink-0 sm:text-left sm:text-base"
          >
